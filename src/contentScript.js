...
function extractCommentData(comment) {
  ...
  const images = Array.from(
    comment.querySelectorAll('.comment__content img')
  ...
  chrome.runtime.sendMessage(
    ...
    (commentData) => {
      ...
      if (commentData) {
        ...
        commentElement.querySelector('.comment__content>span').textContent =
          commentData.text;

        if (commentData.images) {
          const commentContent =
            commentElement.querySelector('.comment__content');
